...
const controlSearchResults = async function() {
    try {
        ...
        (0, _resultsViewJsDefault.default).render(_modelJs.getSearchResultsPage()); //some results
...
const controlBookmarks = function() {
    // Render bookmarks in the beginning (bookmarks panel)
    (0, _bookmarksViewJsDefault.default).render(_modelJs.state.bookmarks);
};
...
const init = function() {
    ...
    (0, _paginationViewJsDefault.default).addHandlerPgnClick(controlPagination);
...
const updateServings = function(newServings) {
    ...
    // newQt = oldQuantity * newServings / oldServings
    });
...
const KEY = "9e6d9f5d-2c11-41f0-a69d-ad530003f67a";
...
},{"./View":"5cUXS","../../img/icons.svg":"cMpiy","fraction.js":"iDLoJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg"); // Parcel 2
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
},{"regenerator-runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cSbZE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
        ...
        if (curPage === 1 && numPages > 1) return this._generateMarkupButton(1);
        // On last page (previous button)
        if (curPage === numPages && numPages > 1) return this._generateMarkupButton(-1);
        // On other pages (next & previous button)
        if (curPage < numPages) return `${this._generateMarkupButton(-1) + this._generateMarkupButton(1)}`;
    ...
    _generateMarkupButton(numeralDirection) {
        ...
        const icon = `
    <svg class="search__icon">
      <use href="${(0, _iconsSvgDefault.default)}#icon-arrow-${numeralDirection < 0 ? "left" : "right"}">
      </use>
    </svg>`;
        const page = `
    ...
    `;
        return `
      <button data-goto="${numeralDirection + currentPage}" class="btn--inline pagination__btn--${numeralDirection < 0 ? "prev" : "next"}">
